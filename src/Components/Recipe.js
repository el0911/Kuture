...
export const Recipe = [
  {
    ...
    Needed: "What you’ll need: Maggi, Salt.",
    Ingredients_title: "Ingredients in your box",
    ingredients: [
      " 1 piece of onion",
      "3 tablespoons of bitter leaf",
      "6 pieces of smoked Meat & fish",
      "10 grams of waterleaf",
      "15 grams of cut pumpkin leaves",
      "3 pieces of fresh chilies",
      "4 teaspoons of ground crayfish",
      "40 grams of ground melon seeds (egusi)",
      "20 grams of cup palm oil",
      "2 teaspoons fresh locust beans (iru, une )",
    ],
    preparation: "Recipe Steps",
    prepare_steps: [
      "Prepare the egusi paste.",
      "Blend egusi seeds and onion mixture. Set aside.",
      "In a large pot, heat the palm oil on medium for a minute and then add the local beans.",
